function [r_ECI, v_ECI] = kep2car(varargin)
...
%
% If mu is not provided in the arguments, mu_Earth is assumed
%
% astroConstants.m is required to run this function

switch nargin
    case 1
        % Single argument: [a, e, i, OM, om, th]
        KEP = varargin{1};
        [a, e, i, OM, om, th] = deal(KEP(1), KEP(2), KEP(3), KEP(4), ...
                                     KEP(5), KEP(6));
