function acc_pert_vect = acc_pert_function_test(t, kep_el, J2, mu, R_planet, date_mjd2000, tilt, n_planet)
% ---------------------------------------------------------------------------------------------
...
a_3B = mu_3B * (r_SC_3B/(norm(r_SC_3B))^3 - r_CB_3B/(norm(r_CB_3B))^3);
