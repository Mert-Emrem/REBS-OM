function acc_pert_vect = acc_pert_function_cartesian(t, cart_coord, J2, mu, R_planet, date_mjd2000, tilt, n_planet)
% ---------------------------------------------------------------------------------------------
...
%
% Author: Serlini Mariagiulia, Bernasconi Ludovico, Emrem Mert, Giovanni
%         Richero
